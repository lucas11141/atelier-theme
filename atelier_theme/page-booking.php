...
<div class="js__prices js__values" style="display:none;">
	<span id="price__base"><?php if( $product_cat !== "Kunstevent" ) { echo $price_base; } ?></span>
	<span id="price__hour"><?= $price_per_hour ?></span>
	<span id="price__person"><?= $price_per_person ?></span>
	<span id="duration"><?php if( $product_cat === "Kunstevent" ) { echo "Dauer wählen..."; } else { echo $duration; } ?></span>
	...
	<div class="book">
		...
		<div class="wrapper">
			...
			<div class="book__header">
				<a class="back__button --color-<?= $color_name ?> quit__button" data-product-link="<?= $product_url ?>">
			...
			<div class="book__container">
				...
				<div class="book__half book__half--process">
					...
					<div class="process__buttons">
						...
						<?php else: ?>
							<a class="back__button --color-<?= $color_name ?> quit__button show--mobile" data-product-link="<?= $product_url ?>">
								<span>Buchung verlassen</span>
							</a>
