		...
		var e = {
				422: (e, t, n) => {
					...
					var a = {
							...
							display: { foreground: 'rgba(255, 255, 255, 0.8)', background: 'var(--product-color)' },
							picker: { foreground: 'rgb(0, 0, 0)', background: '#f5f5f6' },
							picker_header: { active: '#818181', inactive: 'rgba(0, 0, 0, 0.2)' },
							weekday: { foreground: 'var(--product-color)' },
							button: {
								success: { foreground: 'var(--product-color)' },
								danger: { foreground: '#e65151' },
							},
							date: {
								active: {
									default: { foreground: 'rgb(0, 0, 0)' },
									picked: { foreground: '#ffffff', background: 'var(--product-color)' },
									today: { foreground: 'rgb(0, 0, 0)', background: 'rgba(0, 0, 0, 0.2)' },
								},
								inactive: {
									default: { foreground: 'rgba(0, 0, 0, 0.2)' },
									picked: { foreground: 'var(--product-color)', background: 'var(--product-color)' },
									today: { foreground: 'rgba(0, 0, 0, 0.2)', background: 'rgba(0, 0, 0, 0.2)' },
								},
								marcked: { foreground: 'var(--product-color)' },
							},
							month_year_preview: {
								active: {
									default: { foreground: 'rgb(0, 0, 0)' },
									picked: { foreground: 'rgb(0, 0, 0)', background: 'rgba(0, 0, 0,0.2)' },
								},
								inactive: {
									default: { foreground: 'rgba(0, 0, 0, 0.2)' },
									picked: { foreground: 'rgba(0, 0, 0, 0.2)', background: 'rgba(0, 0, 0, 0.2)' },
								},
							},
						},
						r = {
							...
							return {
								...
								open: function (n) {
									...
									this.isClosing ||
										...
										(function (e, t) {
											e.dispatchEvent(
												new CustomEvent(i, { bubbles: !0, detail: { instance: t } })
											)
										})(e, n),
								...
								blur: function () {
									...
									return (
										(this.isBluring = !0),
										L(100).then(function () {
											return e.closed || e.isOpening || e.isClosing
												? !r
												: !(a && !a.options.closeOnBlur) &&
														(e.close(), (e.isBluring = !1), (e.blured = !0), !0)
										})
									)
								},
							}
					...
					var W = function (e) {
						...
						I = function (e) {
							return (
								W(e).string() &&
								/(?:#|0x)(?:[a-f0-9]{3}|[a-f0-9]{6})\b|(?:rgb|hsl)a?\([^\)]*\)/gi.test(e)
							)
						},
						$ = function (e) {
							var t =
								/^(?:(d{1,4}|m{1,4}|y{4}|y{2})?\b(?:(?:,\s)|[.-\s\/]{1})?(d{1,4}|m{1,4}|y{4}|y{2})?\b(?:(?:,\s)|[.-\s\/]{1})?(d{1,4}|m{1,4}|y{4}|y{2})\b(?:(?:,\s)|[.-\s\/]{1})?(d{1,4}|m{1,4}|y{2}|y{4})?\b)$/gi
							return {
								isValid: function () {
									var n = t.test(e)
								...
								var t = z(['active', 'inactive', 'marcked'], e),
									n = Object.keys(e).every(function (t) {
										...
										var r = Object.keys(n).every(function (e) {
											return J(
												'default' === e ? ['foreground'] : ['foreground', 'background'],
												n[e]
											)
										})
										return a && r
								...
								return (
									...
									0 ===
										(a = Object.keys(t)
											...
											.map(function (e) {
												return new Error(
													'Data does not match the schema for property: "'.concat(e, '"')
												)
											})).length ||
						...
						Z = function (e, t) {
							...
							e.hasOwnProperty('allowedMonths') &&
								e.hasOwnProperty('disableMonths') &&
								n.unshift(
									new Error('"disableMonths" option cannot be used along with "allowedMonths" option')
								),
								e.hasOwnProperty('allowedYears') &&
									e.hasOwnProperty('disableYears') &&
									n.unshift(
										new Error(
											'"disableYears" option cannot be used along with "allowedYears" option'
										)
									)
							var a = Object.keys(e)
								.filter(function (n) {
							...
							return (
								e.hasOwnProperty('minDate') &&
									e.hasOwnProperty('maxDate') &&
									O(e.minDate) >= O(e.maxDate) &&
									n.push(new Error('maxDate should be greater than minDate')),
						...
						Q = function (e, t) {
							return '<span style="transform: translateX('
								.concat('next' === e ? '-100' : '100', 'px);">')
								.concat(t, '</span>')
						}
					var ee = function (e) {
							e.linkedElement &&
								...
								i = function (t) {
									...
									return (
										...
										(function (e, t) {
											...
											(r.push('mc-date--picked'), (t.ariaLabel = 'Picked: '.concat(t.ariaLabel))),
										(function (e, t) {
											var n = e.options,
											...
											(r.push('mc-date--marked'), (t.ariaLabel = 'Marked: '.concat(t.ariaLabel))),
										(function (e) {
											var t = e.date
											return O(t) === O(new Date())
										})(t) &&
											(r.push('mc-date--today'), (t.ariaLabel = 'Today: '.concat(t.ariaLabel))),
										(t.classList = r.join(' ')),
										t
									)
								}
								...
								r.addEventListener(i, function (n) {
										...
										if (t) {
											...
											if (!e.target.classList.contains('mc-month-year__cell--inactive')) {
												...
												if (
													...
													return pe(t, a)
												;(o.preview.setTarget = d[0]),
													(o.header.setTarget = d[0]),
									...
									r.addEventListener(p, function (e) {
										...
										if (
											((r.pickedDate = c),
											ye(r),
											(null === (n = t) || void 0 === n ? void 0 : n._id) === r._id)
										) {
											var i = t.store
											;(i.display.setDate = c),
												(i.calendar.setDate = i.calendar.date),
												'calendar' !== i.preview.target &&
													((i.preview.month = c.getMonth()),
													(i.preview.year = c.getFullYear()),
													(i.preview.setTarget = i.preview.target)),
												'month' === i.header.target &&
													((i.header.month = c.getMonth()),
													(i.header.year = c.getFullYear()),
													(i.header.setTarget = i.header.target))
										}
									}),
									...
									E.addEventListener('keydown', function (n) {
										'Enter' == n.key && we(t, e, 'keyboard'),
											'Tab' != n.key || n.shiftKey || (n.preventDefault(), E.focus())
									}),
					...
					var se = function (e) {
						...
						ge = function (e, t) {
							var n = e.displayDay,
								...
								v = l.customWeekDays,
								m = l.customMonths
							l.showCalendarDisplay
								? i.classList.remove('u-display-none')
								: i.classList.add('u-display-none'),
								i.setAttribute('data-target', o.display.target),
								(c.innerText = u.getFullYear()),
								'year' !== s &&
									((r.innerText = m[u.getMonth()]),
									'month' !== s && ((n.innerText = v[u.getDay()]), (a.innerText = u.getDate())))
						},
						be = function (e, t) {
							var n = e.dateCells,
								a = t.store,
							...
							if ('calendar' === r[0]) {
								...
								n.forEach(function (e, t) {
									;(e.innerText = i[t].dateNumb),
										(e.classList = i[t].classList),
										e.setAttribute('data-val-date', i[t].date),
										e.setAttribute('tabindex', i[t].tabindex),
										e.setAttribute('aria-label', i[t].ariaLabel)
								})
							}
						},
						_e = function (e, t) {
							...
							if (
								...
								(function (e, t) {
									var n = e.monthNavPrev,
										...
										y = j(r),
										g = j(c)
									if ((y.active(), g.active(), h.active(), p.active(), 'year' === v))
										return (
											h.inactive(),
											p.inactive(),
											o && o.getFullYear() > f - 1 && y.inactive(),
											void (l && l.getFullYear() < f + 12 && g.inactive())
										)
									var b = me(t, s[m], 'prev'),
										_ = me(t, s[m], 'next'),
								...
								(n.innerHTML = '<span>'.concat(o[s], '</span>')),
									(a.innerHTML = '<span>'.concat(u, '</span>')),
									(c.innerText = ''.concat(o[s], ' ').concat(u))
							else {
								var v = u
								a.innerHTML = '<span>'
									.concat(v, '</span><span> - </span><span>')
									.concat(v + 11, '</span>')
							}
						},
						ke = function (e, t) {
											...
											a.setAttribute('aria-expanded', !0),
												l.map(function (e, t) {
													var a = ['mc-month-year__cell'],
														...
														m = e
													e === d &&
														(a.push('mc-month-year__cell--picked'),
														(m = 'Current Month: '.concat(m))),
														u || v || !ae(o, t) || !re(o, Number(s))
															? (a.push('mc-month-year__cell--inactive'),
											...
											r.setAttribute('aria-expanded', !0),
												a.forEach(function (e, t) {
													...
													c === u && r.push('mc-month-year__cell--picked'),
														v || m || !re(l, c)
															? (r.push('mc-month-year__cell--inactive'),
															  a[t].setAttribute('tabindex', -1))
															: a[t].setAttribute('tabindex', 0),
														(e.classList = r.join(' ')),
						...
						we = function (e, t) {
							...
							if ('month' !== r[0]) {
								...
								i && o
									...
									: ((a.header.setTarget = 'month'),
									  (a.preview.setTarget = 'month'),
									  'keyboard' == n && c.querySelector('[tabindex="0"]').focus())
							}
						},
						De = function (e, t) {
							var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 'click',
							...
							if ('year' !== r[0]) {
								...
								if (i && l)
									return (
										(a.header.year = a.preview.year),
										(a.preview.setTarget = r[0]),
										void (a.header.setTarget = r[0])
									)
								;(a.header.year = a.preview.year - 4),
									(a.header.setTarget = 'year'),
									(a.preview.setTarget = 'year'),
									'keyboard' == n && c.querySelector('[tabindex="0"]').focus()
							}
						},
						xe = function (e, t) {
					...
					function Me(e, t, n) {
						...
						var r = null !== n.el ? n.context.querySelector(n.el) : null,
							...
							i = (function (e) {
								...
								return (
									t && u && (r = new Date(Math.max(t, u))),
									n && v && (c = new Date(Math.min(n, v))),
									r || (r = t || u),
									c || (c = n || v),
									{ prevLimitDate: r, nextLimitDate: c }
								)
							})(n),
							o = i.prevLimitDate,
							l = i.nextLimitDate,
							...
							u = (function (e, t) {
								...
								return {
									...
									display_foreground: {
										...
										color:
											(null == t || null === (n = t.display) || void 0 === n
												? void 0
												: n.foreground) || e.display.foreground,
									},
									display_background: {
										cssVar: '--mc-display-background',
										color:
											(null == t || null === (a = t.display) || void 0 === a
												? void 0
												: a.background) ||
									...
									picker_foreground: {
										...
										color:
											(null == t || null === (r = t.picker) || void 0 === r
												? void 0
												: r.foreground) ||
									...
									picker_background: {
										...
										color:
											(null == t || null === (c = t.picker) || void 0 === c
												? void 0
												: c.background) ||
											(null == t ? void 0 : t.main_background) ||
											e.picker.background,
									},
									picker_header_active: {
										cssVar: '--mc-picker-header-active',
										color:
											(null == t || null === (i = t.picker_header) || void 0 === i
												? void 0
												: i.active) || e.picker_header.active,
									},
									picker_header_inactive: {
										cssVar: '--mc-picker-header-inactive',
										color:
											(null == t || null === (o = t.picker_header) || void 0 === o
												? void 0
												: o.inactive) ||
											(null == t ? void 0 : t.inactive_text_color) ||
											e.picker_header.inactive,
									},
									weekday_foreground: {
										cssVar: '--mc-weekday-foreground',
										color:
											(null == t || null === (l = t.weekday) || void 0 === l
												? void 0
												: l.foreground) ||
											(null == t ? void 0 : t.theme_color) ||
											e.weekday.foreground,
									},
									...
									button_danger_foreground: {
										...
										color:
											...
											void 0 === v
												? void 0
												: v.foreground) || e.button.danger.foreground,
									},
									...
									date_active_picked_foreground: {
										...
										color:
											...
											void 0 === g
												? void 0
												: g.foreground) || e.date.active.picked.foreground,
									},
									...
									month_year_preview_active_picked_background: {
										...
										color:
											...
											void 0 === Q
												? void 0
												: Q.background) || e.month_year_preview.active.picked.background,
									},
									month_year_preview_inactive_default_foreground: {
										cssVar: '--mc-prev-inactive-def-foreground',
										color:
											(null == t ||
											null === (ee = t.month_year_preview) ||
											void 0 === ee ||
											null === (te = ee.inactive) ||
											void 0 === te ||
											null === (ne = te.default) ||
						...
						return (
							(n.theme = u),
							{
								...
								getFormatedDate: function () {
									return this.pickedDate
										? T(this.pickedDate, this.options, this.options.dateFormat)
										: null
								},
								markDatesCustom: function (e) {
							...
							}),
							{
								...
								remove: function (e) {
									...
									if (
										Ee.length &&
										n &&
										((t = n.linkedElement) && (t.onfocus = null),
										Ee.splice(Ee.indexOf(n), 1),
										!Ee.length)
									) {
										var a = Le.calendar
...
jQuery(document).ready(function ($) {
	...
	if (document.querySelector('.button--toggle-site.--to-website')) websiteMode = 'shop'
	...
	const siteToggleLinks = JSON.parse(sessionStorage.getItem('site_toggle_links'))
	const toggleTo = websiteMode === 'website' ? 'shop' : 'website'
	const toggleToLink = siteToggleLinks[toggleTo]
	if (toggleToLink) {
		document.querySelectorAll('.nav__toggle__site a, .button--toggle-site').forEach((button) => {
	...
	document.querySelectorAll('.nav__toggle__site a, .button--toggle-site').forEach((button) => {
		button.addEventListener('click', (e) => {
			...
			sessionStorage.setItem('site_toggle_links', JSON.stringify(siteToggleLinks))
		})
	})
		...
		if (target.classList.contains('accordeon__item--opened')) {
			setTimeout(function () {
				if (window.innerHeight < target.offsetHeight + 100) {
					...
					window.scrollTo({
						behavior: 'smooth',
						top: target.getBoundingClientRect().top - document.body.getBoundingClientRect().top - 115,
					})
				} else {
	...
	$('.accordeon').not('.accordeon--closed').find('.accordeon__item').first().addClass('accordeon__item--opened')
	$('.accordeon').not('.accordeon--closed').find('.accordeon__item').first().find('.accordeon__content').show()
	...
	waitForElementToDisplay(
		'.wpcf7-not-valid-tip',
		function () {
			$('.wpcf7-not-valid-tip').parent().parent().find('.labeltext').css('color', 'rgb(218, 15, 15)')
		},
		10,
		9000
	)
	...
	if (document.querySelector('.kasse')) {
		...
		observer.observe(noticesWrapper, { characterData: false, childList: true, attributes: false })
	}
	...
	darkBackgrounds.forEach((element) => {
		...
		backgroundElement.src =
			'https://atelier-delatron.de/wp-content/themes/atelier_theme/img/website/background_dark_image.jpg'
