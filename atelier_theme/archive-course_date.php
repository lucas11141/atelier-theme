                ...
                <div class="header__text">
                    ...
                    <?php else : ?>
                        <div class="two-buttons">
                            <div class="filter--1">
                                <?php get_template_part('components/button', '', array('color' => 'blue', 'button' => array('title' => 'Für Kinder', 'url' => '#list'))); ?>
                            </div>
                            <div class="filter--2">
                                <?php get_template_part('components/button', '', array('color' => 'purple', 'button' => array('title' => 'Für Erwachsene', 'url' => '#list'))); ?>
                            </div>
                        </div>
                    <?php endif; ?>
