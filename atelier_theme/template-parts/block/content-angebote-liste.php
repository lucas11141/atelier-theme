...
<div id="angebote" class="angebote__list">
	...
	<div class="list__item item--1" id="<?= $courses[ "anchor" ] ?>">
		...
		<div class="item__image">
			...
			<?php endif; ?>
			<img class="image__mask" src="<?= get_template_directory_uri(); ?>/img/website/home/mask_blue.svg" alt="">
		</div>
	...
	<div class="list__item item--2" id="<?= $workshops[ "anchor" ] ?>">
		...
		<div class="item__image">
			...
			<?php endif; ?>
			<img class="image__mask" src="<?= get_template_directory_uri(); ?>/img/website/home/mask_red.svg" alt="">
		</div>
	...
	<div class="list__item item--3" id="<?= $birthdays[ "anchor" ] ?>">
		...
		<div class="item__image">
			...
			<?php endif; ?>
			<img class="image__mask" src="<?= get_template_directory_uri(); ?>/img/website/home/mask_green.svg" alt="">
		</div>
	...
	<div class="list__item item--4" id="<?= $kunstevents[ "anchor" ] ?>">
		...
		<div class="item__image">
			...
			<?php endif; ?>
			<img class="image__mask" src="<?= get_template_directory_uri(); ?>/img/website/home/mask_pink.svg" alt="">
		</div>
