				...
				<div class="email-starter">
					<img src="https://atelier-delatron.de/img/portrait_120x.jpg">
					<div>
				...
				<div class="email-field course-infos <?php echo $course_group; ?>">
					<div class="field-padding">
						<div class="course-header">
							<img src="https://atelier-delatron.de/img/courses/course-images/course_<?php echo $course_image ?>_250x.jpg">
							<div>
						...
						<p><?php 
							...
							$servername = "db5001988950.hosting-data.io";$username = "dbu782740";$password = "P6kgZoW8cJckujXLQqKY";$dbname = "dbs1623575";$mysql = new mysqli($servername, $username, $password, $dbname);
